...
import savedFeed from "../../../../assets/images/common/savedFeed.png";
...
import Bookmark from "../../../../assets/images/common/bookmark.png";
        ...
        <View style={styles.card}>
            ...
            <View style={styles.actions}>
                ...
                <View style={styles.actionRow}>
                  ...
                  <View style={styles.actionRow}>
                    <Image source={Bookmark} style={styles.actionIcon} />
                </View>
            </View>
        </View>
    );
        ...
        <View style={{ flex: 1, backgroundColor: "#F2F5F4" }}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
                ...
                <View style={styles.cover}>
                    <Image source={savedFeed} style={{ width: 60, height: 60 }} resizeMode="contain" />
