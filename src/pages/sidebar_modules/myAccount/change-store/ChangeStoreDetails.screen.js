      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        ...
        <View style={styles.locationRow}>
          ...
          <View style={{ marginLeft: 18 }}>
            ...
            <Text style={styles.locationCoords}>19.2408164, 72.8425479</Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          {/* <Image
            source={require('../assets/store-sample.png')} // 🔥 Replace this with your store image
          ...
          <View style={{ paddingHorizontal: 16, paddingVertical: 10 }}>
            ...
            <View style={styles.infoRow}>
              {/* <MaterialIcons name="call" size={18} color="orange" /> */}
...
const styles = StyleSheet.create({
  ...
  storeCount: { fontSize: 14, fontWeight: "600", marginVertical: 8, color: "#333" },
